      ...
      <nav className="max-w-6xl mx-auto glass rounded-2xl shadow-lg shadow-slate-200/20 px-6 py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-1">
            <Link
              href="/learn"
              className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium text-slate-600 hover:text-cyan-600 hover:bg-cyan-50/50 transition-all"
            >
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="w-10 h-10 rounded-full bg-slate-100 hover:bg-cyan-50 flex items-center justify-center transition-colors cursor-pointer group">
